...
public class MonsterListOverlayWithAdd extends Extension{
	...
	public MonsterListOverlayWithAdd(int x, int y, double scale, LinkedList<Monster> monsters) {
		...
		for(int i = 0; i < 10; i++) {
			plusButtons[i] = new MyButton((int)(x + (30*scale)),(int)(y + ((15 + 65 * i) * scale)),
					plusButtonSize,plusButtonSize,(int)(6*scale),(int)(70*scale),Color.gray, Color.white, "+",(int)(7*scale),(int)(52*scale));
		}
		...
		for(int i = 0; i < 10; i++) {
			plusFields[i] = new TextField((int)(x + (30*scale)),(int)(y + ((15 + 65 * i) * scale)),
					plusFieldWidth,plusFieldHeight,plusFieldEdge,plusFieldFontSize,Color.gray, Color.white,"", "",plusFieldXOffset,plusFieldYOffset,20);
