...
public class SynthesisListOverlayWithAdd extends Extension{
	...
	private boolean somethingInSearchField = false, addingRecipe = false, lookingAtRecipe = false, writingL = false, writingR = false;
	...
	public SynthesisListOverlayWithAdd(int x, int y, double scale, LinkedList<Monster> monsters, LinkedList<Recipe> allRecipes) {
		this.x = x;
		this.y = y;
		...
		overlay = new MonsterListOverlayWithAdd(x+(int)(100*this.scale),y+(int)(820*this.scale),this.scale/1.4,monsters);
		
		//initializing buttons and Text fields
		searchField = new TextField((int)(x + (520*this.scale)),(int)(y + ((250) * this.scale)),
		(int)(130*this.scale),(int)(50*this.scale),(int)(6*this.scale),(int)(26*this.scale),
		Color.gray, Color.white, "","",
		(int)(10*this.scale),(int)(35*this.scale),20);

		up = new MyButton((int)(x + (550*this.scale)),(int)(y + ((310) * this.scale)),
		...
		down = new MyButton((int)(x + (550*this.scale)),(int)(y + ((350) * this.scale)),
		...
		searchButton = new MyButton((int)(x + (520*this.scale)),(int)(y + ((250) * this.scale)),
				(int)(130*this.scale),(int)(50*this.scale),(int)(6*this.scale),(int)(26*this.scale),
		...
		for(int i = 0; i < 10; i++) {
			listButtons1[i] = new MyButton((int)(x + (30*this.scale)),(int)(y + ((30 + 65*i) * this.scale)),
			...
			listButtons2[i] = new MyButton((int)(x + (280*this.scale)),(int)(y + ((30 + 65*i) * this.scale)),
					(int)(220*this.scale),(int)(60*this.scale),(int)(6*this.scale),(int)(20*this.scale),
					Color.gray, Color.white, "Hello World",
					(int)(10*this.scale),(int)(40*this.scale));
		}
		
		plusButton = new MyButton((int)(x + (30*this.scale)),(int)(y + (720 * this.scale)),
						(int)(60*this.scale),(int)(60*this.scale),(int)(6*this.scale),(int)(80*this.scale),
						Color.gray, Color.white, "+",
						(int)(8*this.scale),(int)(56*this.scale));
		
		add = new MyButton((int)(x + (550*this.scale)),(int)(y + (730 * this.scale)),
		...
		plusField1 = new TextField((int)(x + (30*this.scale)),(int)(y + ((720) * this.scale)),
						(int)(220*this.scale),(int)(60*this.scale),(int)(6*this.scale),(int)(35*this.scale),
						Color.gray, Color.white, "","",
						(int)(10*this.scale),(int)(40*this.scale),20);
		
		
		plusField2 = new TextField((int)(x + (280*this.scale)),(int)(y + ((720) * this.scale)),
						(int)(220*this.scale),(int)(60*this.scale),(int)(6*this.scale),(int)(35*this.scale),
						Color.gray, Color.white, "","",
						(int)(10*this.scale),(int)(40*this.scale),20);
			...
			if(hasMonster()) {
				...
				if(add.pressed()) {
					...
					if(inList(plusField1.getText()) && inList(plusField2.getText())) {
						Recipe temp = new Recipe(curMonster,getMonster(plusField1.getText()),getMonster(plusField2.getText()));
						curMonster.add(temp);
						allRecipes.add(temp);
						addingRecipe = false;
						writingL = false;
